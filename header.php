					...
					<ul class="main-menu nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content">
								<a href="http://127.0.0.1/jugal/login.php">Career Prediction</a>
                                <a href="http://127.0.0.1/jugal/courses.php">Courses</a>
                                <a href="http://127.0.0.1/jugal/blog.php">Knowledge Network</a>
